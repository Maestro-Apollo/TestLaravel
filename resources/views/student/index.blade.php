        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="" id="" required class="gender form-control">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="tel" required class="phone form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Class</label>
                    <input type="text" required class="class form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Education Year</label>
                    <input type="text" required class="eduyear form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Address</label>
                    <textarea name="" id="" class="address form-control" cols="30" rows="10"></textarea>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label for="">Class</label>
                    <input type="text" id="class" required class="form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Education Year</label>
                    <input type="text" id="eduyear" required class="form-control">
                </div>
                <div class="form-group mb-3">
                    <label for="">Address</label>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 404) {
                        ...
                        $('#eduyear').val(response.student.eduyear);
